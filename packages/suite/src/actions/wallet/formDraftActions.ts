import { GetState } from '@suite-types';
import { FormDraftKeyPrefix, FormDraft } from '@wallet-types/formDraft';
...
const getFormDraftKey = (prefix: FormDraftKeyPrefix, key: string) => `${prefix}/${key}`;
